#############################################################################
# Makefile for building: juan2ascii
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  juan2ascii.pro
# Template: app
# Command: /home/jan/Qt/5.5/gcc_64/bin/qmake -spec linux-g++ -o Makefile juan2ascii.pro
#############################################################################
...
QMAKE         = /home/jan/Qt/5.5/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = juan2ascii1.0.0
DISTDIR = /home/jan/Documents/Qt\ Projects/sivinska_slika/.tmp/juan2ascii1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/jan/Qt/5.5/gcc_64
...
DIST          = ../../../Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		juan2ascii.pro edge_detection.h \
		show.h \
		thresholds.h \
		asciiconverter.h \
		stopwatch.h main.cpp \
		edge_detection.cpp \
		show.cpp \
		thresholds.cpp \
		asciiconverter.cpp \
		stopwatch.cpp
QMAKE_TARGET  = juan2ascii
...
Makefile: juan2ascii.pro ../../../Qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.5/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.5/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.5/gcc_64/mkspecs/features/lex.prf \
		juan2ascii.pro
	$(QMAKE) -spec linux-g++ -o Makefile juan2ascii.pro
...
edge_detection.o: edge_detection.cpp edge_detection.h \
		show.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o edge_detection.o edge_detection.cpp

show.o: show.cpp show.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o show.o show.cpp

thresholds.o: thresholds.cpp thresholds.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o thresholds.o thresholds.cpp

asciiconverter.o: asciiconverter.cpp asciiconverter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o asciiconverter.o asciiconverter.cpp
